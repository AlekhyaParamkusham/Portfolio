...
const Experience = () => {
  return (
    ...
    >
      <div className="flex flex-col  justify-center items-center w-full lg:w-5/6 bg-white p-6 lg:py-6 lg:px-10 gap-4">
        <h1 className="text-2xl tracking-wider font-bold text-red-500 mb-3 ">
          EXPERIENCE
        </h1>
        <p className="text-red-700">--- To be updated! ---</p>

        <div className="flex flex-col md:flex-row justify-center items-start gap-3 md:gap-10 w-full md:w-full p-3">
          <div className="flex flex-1 flex-col   gap-2">
           ...
           <h2 className="text-sm font-semibold text-slate-600 tracking-wide uppercase p-1 w-max" style={{background:"#EFEFEF"}}>APPLICATION DEVELOPMENT ANALYST</h2>
            <p style={{fontFamily:'Barlow'}} className="text-sm font-medium md:tracking-wide text-center lg:text-left">Accenture Service Pvt.Ltd | 2019 - 2021</p>
          ...
          <div className="flex flex-1 flex-col gap-2">
            ...
            <p style={{fontFamily:'Barlow'}} className="text-sm font-medium md:tracking-wide text-center lg:text-left">Accenture Service Pvt.Ltd | 2017 – 2019</p>
            <li className="text-xs text-gray-600 text-left tracking-wide leading-relaxed">
