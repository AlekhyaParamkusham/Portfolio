...
import paint from "./../Images/paintback.png"
...
const Navbar = () => {
  ...
  return (
    <>
      <div
        className="flex justify-between md:justify-center items-center fixed top-0 z-10 right-0 w-full p-1"
        style={{
          background:
      ...
      >
        <div className="flex md:justify-center items-start md:items-center p-2 md:p-3 justify-between w-full">
          ...
          <div
            className={
              isNavOpen ? "showMenuNav glassNav" : "hideMenuNav glassNav"
            }
